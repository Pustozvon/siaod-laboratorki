...
namespace Лабораторная_работа__3
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Учитывать пробел?");
            if (Console.ReadLine() == "нет")
            {
            ...
            Console.WriteLine("Содержится ли подстрока в строке? (алгоритм Кнута-Морриса-Пратта): " + FindSubstring1(MyString2, MyString1));
            Console.WriteLine("Содержится ли подстрока в строке? (алгоритм Упрощенный Бойера-Мура): " + FindSubstring2(MyString2, MyString1));
            Console.ReadLine();
            #endregion
